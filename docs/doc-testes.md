...
| ----- | --------- | -------------- | -------- |
| Teste 01: Inserir Usuário | A1 - Inserir Usuário<br> A1.1. O ator preenche os dados;<br> A1.2. O ator clica no botão Enviar;<br>A1.3. O sistema salva os dados<br>A1.4. O sistema retorna para a página de cadastro de Usuário;<br>A1.5. Fim do fluxo. | Especificação OK. | Ao cadastrar um usuário, é necessário informar o nome, email, cpf e telefone.|
...
| Teste | Descrição | Especificação | Resultado |
| ----- | --------- | -------------- | -------- |
| Teste 01: Incluir Despensa | A1 - Incluir Despensa<br> A1.1. O ator preenche os dados;<br> A1.2. O ator clica no botão Enviar;<br>A1.3. O sistema salva os dados<br>A1.4. O sistema retorna para a página de cadastro de Despensa;<br>A1.5. Fim do fluxo. | Especificação OK. | Ao cadastrar uma despensa, é necessário informar a quantidade total e a capacidade. No entanto, esses dois atributos não estão sendo devidamente relacionados. Por exemplo, se for inserido um valor de total de 7000 e a capacidade for apenas 500, o sistema cadastra a despensa de qualquer maneira. Deve haver coerência entre esses dois atributos para garantir a consistência dos dados. Além disso, é possível cadastrar mais de uma despensa com as mesmas características, o que pode gerar duplicidade de dados. |
