...
| Teste 04: Listar Despensas | A4 - Listar Despensas<br> A4.1. - O ator clica no botão Despensas;<br> A4.2. - O sistema redireciona para a página de listagem de Despensas;<br>A4.3. O sistema faz uma consulta aos dados das Despensas cadastradas;<br>A4.4. - O sistema mostra uma mensagem se não houver Despensas cadastradas.
| A4.5. - O sistema lista todas as Despensas na página;<br>A4.6. Fim do fluxo. | Especificação OK. | OK. |
